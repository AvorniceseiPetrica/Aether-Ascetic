...
void AA_GameOverState::Init()
{
    background = AA_TextureLoader::LoadTexture("assets/menu/game_over_background.png");
...
void AA_GameOverState::HandleEvents()
{
    SDL_Event e;
